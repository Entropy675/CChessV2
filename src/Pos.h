...
// If something is ending up on the top left corner for no reason, its likely defaulting because the value
// its initialized with is invalid.
class Pos
{
	...
	// - the meaning relative to this chess application is unclear.
	int& operator[](int);
